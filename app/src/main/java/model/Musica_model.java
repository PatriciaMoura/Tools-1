...
public class Musica_model {
    ...
    private int quantfaixas, faixafavorita;
    ...
    public Integer getFaixafavorita () { return faixafavorita ;}
    public void setFaixafavorita (Integer faixafavorita) {this.faixafavorita = faixafavorita;}
